...
const PetsAndSupplies = () => {
    ...
    return (
     ...
     <title>PawMart | Pets&Supplies</title>
        ...
        {
            data.map((d)=><div key={d._id}  className="card border w-96 shadow-sm  transform transition-transform duration-150  hover:-translate-y-4  cursor-pointer  border-[#c74d2f]">
  <figure>
    <img className='p-5'
      src={d.image}
      alt="" />
  ...
  <div className="card-body">
    ...
    <Link to={`/card-ditails/${d._id}`} className='btn border-[#c74d2f] hover:bg-[#c74d2f] hover:text-white active:scale-95 bg-orange-300 '>See Details</Link>
  </div>
</div>)
        }
