...
const PetsAndSupplies = () => {
    ...
    return (
     ...
     <title>PawMart | Pets&Supplies</title>
        ...
        {
            data.map((d)=><div key={d._id}  className="card border-gray-300 border-1  w-96 shadow-sm  transform transition-transform duration-150  hover:-translate-y-4 active:scale-95 cursor-pointer">
  <figure>
    <img className='p-5'
      src={d.image}
      alt="" />
