...
const Banner = () => {
  ...
  <div className="card-body items-center text-center">
    ...
    <p>Discover adorable pets waiting for a forever home. Adoption brings joy to both you and your new companion. Give love, get love — start your adoption journey today."
  </p>
  ...
  <div className="card-body items-center text-center">
    ...
    <p>Keep your pets strong with nutritious meals made for them. We offer top-quality food for dogs, cats, birds, and more. Feed them the best and see their tails wag in delight.</p>
    <div className="card-actions">
  ...
  <div className="card-body items-center text-center">
    ...
    <p>Explore stylish and comfortable accessories your pets deserve. From cozy beds to playful toys, we’ve got it all. Make every moment fun and fashionable for your furry friend.</p>
    <div className="card-actions">
  ...
  <div className="card-body items-center text-center">
    ...
    <p>Ensure your pet’s health with trusted care products. Our range includes shampoos, brushes, and hygiene essentials. Keep your furry buddy clean, fresh, and happy every day.</p>
    <div className="card-actions">
